...
export default function Footer() {
  return (
    <footer className="bg-white border- dark:bg-slate-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <img
                ...
                alt="Logo"
              />
              <h2 className="text-4xl font-semibold">Pikachu</h2>
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/shivamm-verma"
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">
            © 2023
            <a target="_blank" href="https://github.com/shivamm-verma" className="hover:underline">
              ShivamVerma
            </a>
            . All Rights Reserved.
          </span>
